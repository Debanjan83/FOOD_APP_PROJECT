...
<head>
    ...
    <link rel="stylesheet" href="FoodAdd.css">
</head>
<body>
<script>
...
<div class="admin-section">
    <div class="admin-container">
        <h1 class="admin-heading">Welcome to the Food Manager</h1>
        <p class="admin-subtext">
            Here you can <span class="highlight">add new food items</span> to the menu. Make sure each food item has a <span class="highlight">unique ID</span> and a <span class="highlight">clear name</span>. Pricing should be accurate and up to date.
        </p>
        <p class="admin-subtext">
            <span class="highlight">Adding food</span> is quick and easy. Use the form beside to get started!
        </p>
    </div>

    <div class="form-section">
        <h2>ADD FOOD</h2>
        <form action="FoodAddServe" method="post" class="w-100">
